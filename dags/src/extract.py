...
#Get the songs present in my summer playlist https://open.spotify.com/playlist/596plTvKm2Kt9zANVQm6yH
def get_songs_from_playlist(ti):
    ...
    playlist_id = '5vOceoTWL0NykvywJv4rkc'
