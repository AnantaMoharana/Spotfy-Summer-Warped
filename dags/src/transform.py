...
def transform_data(ti):
    ...
    print(list(audio_df.columns.values))
    print('\n')
    print(list(artists_df.columns.values))
    print('\n')
    ...
    artist_dim=pd.merge(songs_df,artists_df,left_on='artist_id',right_on='artist_id', how='inner')
